...
This is a project i have been working on for quite a while, the main purpose of this software is to simulate the bar replay feature for free for everyone and runs locally. The code fetches data from binance api for crypto and mt5 for forex.
While my main intention was to replicate the bar replay feature to the best of my ability i have added another feature which i personally was looking for, i have made api commands which can be used to draw or display or take trades on the chart via a third party python script. My main reason for doing thing was because i needed to see the signals generated by my machine learning models in the screen and for use cases like that where a third party script would need to interact with the chart.

The data input may be a bit limited so i have added a csv file upload option.
---
